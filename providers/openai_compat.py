...
class OpenAIChatTransport(BaseProvider):
    ...
    def __init__(
        ...
        *,
        ...
        self._proxy_http_client: httpx.AsyncClient | None = None
        if config.proxy:
            self._proxy_http_client = httpx.AsyncClient(
                proxy=config.proxy,
        ...
        self._client = AsyncOpenAI(
            ...
            http_client=self._proxy_http_client,
        )
    ...
    async def cleanup(self) -> None:
        ...
        if client is not None:
            await client.aclose()
        proxy = getattr(self, "_proxy_http_client", None)
        if proxy is not None:
            await proxy.aclose()
            self._proxy_http_client = None

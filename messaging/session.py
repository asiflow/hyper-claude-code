...
class SessionStore:
    ...
    def _flush_pending_save_sync(self) -> None:
        """Synchronous flush — used by timer thread and tests."""
        with self._lock:
    ...
    async def flush_pending_save(self) -> None:
        ...
        await asyncio.to_thread(self._flush_pending_save_sync)
    ...
    def _clear_all_sync(self) -> None:
        """Synchronous clear — used by tests."""
        with self._lock:
            self._trees.clear()
